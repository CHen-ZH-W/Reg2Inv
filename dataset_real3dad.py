from geotransformer.datasets.registration.real3dad.dataset import Real3dadPairDataset_train,Real3dadPairDataset_test,Real3dadDataset_train
...
def train_valid_data_loader(cfg, distributed):
    train_dataset = Real3dadPairDataset_train(
    ...
    valid_dataset = Real3dadPairDataset_train(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "val",
        voxel_size=cfg.data.voxel_size,
...
def test_data_loader(cfg):
    ...
    test_dataset = Real3dadPairDataset_test(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "test",
        voxel_size=cfg.data.voxel_size,
...
def bank_data_loader(cfg):
    ...
    test_dataset = Real3dadDataset_train(
        cfg.data.dataset_root,
        cfg.data.class_name,
        "test",
        voxel_size=cfg.data.voxel_size,
