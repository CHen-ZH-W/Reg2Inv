...
from config_real3dad import make_cfg
from dataset_real3dad import train_valid_data_loader 
...
class Trainer(IterBasedTrainer):
    def __init__(self, cfg):
        ...
        train_loader, val_loader, neighbor_limits, voxel_size = train_valid_data_loader(cfg, self.distributed)
        ...
        model = create_model(cfg, voxel_size).cuda()
